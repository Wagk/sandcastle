...
namespace sandcastle::graphics {
  ...
  void simpletriangle::draw_frame()
  {
    ...
    if (vkQueueSubmit(_graphics_queue, 1,
  ...
  {
    if (enable_validation_layers &&
        check_validation_layer_support() == false) {
  ...
  {
    if (glfwCreateWindowSurface(_instance, _window,
                                nullptr, _surface.replace()) != VK_SUCCESS) {
  ...
  simpletriangle::debugcallback_fn(VkDebugReportFlagsEXT       flags,
  ...
  VkResult
  simpletriangle::CreateDebugReportCallbackEXT
  (VkInstance                                instance,
  ...
  simpletriangle::queue_family_indices
  simpletriangle::find_queue_families(VkPhysicalDevice device)
  {
  ...
  VkSurfaceFormatKHR
  simpletriangle::choose_swap_surface_format
  ...
  VkPresentModeKHR
  simpletriangle::choose_swap_present_mode
  ...
  void simpletriangle::on_window_resize(GLFWwindow *window,
                                        int         width,
                                        int         height)
  {
  ...
  void simpletriangle::create_buffer(VkDeviceSize              size,
  ...
  void simpletriangle::copy_buffer(VkBuffer     src_buffer,
                                   VkBuffer     dst_buffer,
                                   VkDeviceSize size)
  {
  ...
  void simpletriangle::create_image(uint32_t                  width,
                                    uint32_t                  height,
                                    VkFormat                  format,
  ...
  void simpletriangle::copy_image(VkImage  src_image,
                                  VkImage  dst_image,
                                  uint32_t width,
                                  uint32_t height)
  {
    ...
    vkCmdCopyImage(command_buffer, src_image,
  ...
  void simpletriangle::transition_image_layout(VkImage       image,
                                               VkFormat      format,
